        ...
        <div className="space-y-12">
          ...
          <FadeUp delay={0.1}>
            <Card className="p-6 md:p-8 bg-card/50 backdrop-blur-sm border-border">
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Not long ago, I was working a minimum-wage job I didn't enjoy.
                  12-hour shifts. 3am starts. Even on Sundays. I felt stuck.  
                  I knew I wanted more, but I had no idea what that “more” actually was.
                </p>
                <p>
                  I tried a few different things. I even dipped into web design 
                  a few times, but nothing ever stuck…  
                  Eventually, I applied for an online computing degree just so I
                  felt like I was moving forward.
                </p>
              </div>
            </Card>
          </FadeUp>
          ...
          <FadeUp delay={0.2}>
            <Card className="p-6 md:p-8 bg-gradient-to-br from-accent/10 to-primary/5 border-accent/20">
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Most of the modules felt… meh. But then there was one basic web
                  design module. Nothing fancy.{" "}
                  <span className="text-accent font-medium">And something clicked.</span>
                </p>
                <p>
                  I went way beyond the requirements, researched endlessly, 
                  and tried to make my project the best it could possibly be.
                  That module ended — but my motivation didn’t.  
                  I realised I didn’t want to go back to the other topics.  
                  I wanted to keep learning web design. Every day. Properly.
                </p>
              </div>
            </Card>
          </FadeUp>
          ...
          <div className="space-y-6">
            <FadeUp>
              <h3 className="text-xl font-semibold text-foreground">
                Fast-forward to today and I now help clients:
              </h3>
            </FadeUp>
            ...
            <StaggerParent>
              {offerings.map((offering) => (
                <StaggerItem key={offering.text}>
                  <div className="flex items-start gap-4 p-4 rounded-lg bg-card/30 border border-border hover:border-accent/50 transition-colors group">
          ...
          <FadeUp delay={0.1}>
            <Card className="p-6 md:p-8 bg-card/50 backdrop-blur-sm border-border">
              <h3 className="text-xl font-semibold text-foreground mb-4">
                Why I love designing and building websites:
              </h3>
            ...
            <Card className="p-6 md:p-8 bg-gradient-to-br from-primary/10 to-accent/5 border-primary/20">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Build a reputation as a fast, reliable web developer who communicates clearly,
                    keeps clients informed, and never leaves them in the dark.
                  </p>

                  <p className="text-foreground font-medium pt-2">
                    If you are a small business owner who wants a website that brings in more clients,
